...
class DatasetPreparator(abc.ABC):
    ...
    @cached_property
    def data_class(self):
        if self.algorithm_name in ["amber", "ours"]:
    ...
    def dataset_class(self):
        if self.algorithm_name in ["amber", "graphmesh", "ours"]:
    ...
    def get_dataset(self, dataset_mode: str) -> MeshGenerationDataset:
        ...
        assert dataset_mode in get_args(DatasetMode), f"dataset_mode '{dataset_mode}' not recognized"

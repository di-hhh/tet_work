...
def get_mpn_from_graph(
    *,
    ...
    print(f"example_graph.x.shape:{example_graph.x.shape}")
    print(f"example_graph.edge_attr.shape:{example_graph.edge_attr.shape}")
    return get_mpn(
...
def get_mpn(
    *,
    ...
    print(f"embeding_config:{embedding_config}")

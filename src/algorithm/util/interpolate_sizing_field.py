...
def interpolate_sizing_field(
    ...
    """
    assert sizing_field_interpolation_type in get_args(
    ...
    elif "element" in sizing_field_interpolation_type:  # handle sizing fields on mesh elements
...
def interpolate_element_sizing_field(fine_mesh, queried_mesh) -> SizingField:
    ...
    return interpolate_element_field(fine_mesh=fine_mesh, queried_mesh=queried_mesh, fine_field=fine_sizing_field)

...
def get_gnn(architecture_config: DictConfig, example_graph: Data) -> nn.Module:
    ...
    elif architecture_config.name == "gat":
        from src.algorithm.architecture.edge_aware_gat import EdgeAwareGat

        return EdgeAwareGat(architecture_config=architecture_config, example_graph=example_graph)
    else:
